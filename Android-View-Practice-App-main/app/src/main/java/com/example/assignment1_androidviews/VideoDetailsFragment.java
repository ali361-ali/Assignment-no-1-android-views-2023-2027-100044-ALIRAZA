...
public class VideoDetailsFragment extends DetailsSupportFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie =
                (Movie) getActivity().getIntent().getSerializableExtra(TextPreviewActivity.MOVIE);
    ...
    private void setupDetailsOverviewRowPresenter() {
        ...
        sharedElementHelper.setSharedElementEnterTransition(
                getActivity(), TextPreviewActivity.SHARED_ELEMENT_NAME);
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_TRAILER) {
                    ...
                    intent.putExtra(TextPreviewActivity.MOVIE, mSelectedMovie);
                    startActivity(intent);
                } else {
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked(
            ...
            if (item instanceof Movie) {
                ...
                Intent intent = new Intent(getActivity(), TextPreviewActivity.class);
                ...
                Bundle bundle =
                        ActivityOptionsCompat.makeSceneTransitionAnimation(
                                        ...
                                        TextPreviewActivity.SHARED_ELEMENT_NAME)
                                .toBundle();
